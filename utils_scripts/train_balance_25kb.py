...
os.makedirs('weights_balance_single_25kb', exist_ok=True)
...
train_model(dataloaders, model, 'log_balance_single_25kb', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name='balance_single_25kb')
torch.save(model.state_dict(), f'weights_balance_single_25kb/balance_single_25kb.pt')

print('Trained balance_single_25kb')