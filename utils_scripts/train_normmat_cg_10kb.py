...
validate_csvs = [f'{local_path}data/sv_csv/filtered_SSY_CHM_diagonal.csv',] 
...
os.makedirs('weights_normmat_cg_48_diag_10Kbp_two_matrices', exist_ok=True)
...
train_model(dataloaders, model, 'log_normmat_cg_48_diag_10Kbp_two_matrices', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name='normmat_cg_48_diag_10Kbp_two_matrices')
torch.save(model.state_dict(), f'weights_normmat_cg_48_diag_10Kbp_two_matrices/normmat_cg_48_diag_10Kbp.pt')
print('Trained normmat_cg_two_matrices_10kb')