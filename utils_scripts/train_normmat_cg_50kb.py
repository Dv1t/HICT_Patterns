...
os.makedirs(f'weights_{cfg.model_name[2]}', exist_ok=True)
...
train_dataset = TrainDatasetDiagonal(
    ...
    resolution=50000,
    image_size=48,
    normmat_path=cfg.normmats_path_train[2],
    normmat_clean_path=cfg.normmats_clean_path_train[2])
...
validate_dataset = TrainDatasetDiagonal(
    ...
    resolution=50000,
    image_size=48,
    normmat_path=cfg.normmats_path_val[2],
    normmat_clean_path=cfg.normmats_clean_path_val[2],
    validate=True)
...
train_model(dataloaders, model, f'log_50kb_{cfg.model_name[2]}', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name=cfg.model_name[2])
torch.save(model.state_dict(), f'weights_{cfg.model_name[2]}/normmat_cg_48_diag_50Kbp.pt')
print(f'Trained 50kb {cfg.model_name[2]} with config {args.cfg_path}')