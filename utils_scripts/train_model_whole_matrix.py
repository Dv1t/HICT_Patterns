...
torch.save(model.state_dict(), f'weights_normmat_whole_4fold/torch_ensemble_25k_48.pt')
...
torch.save(model.state_dict(), f'weights_normmat_whole_4fold/torch_ensemble_50k_48.pt')
...
torch.save(model.state_dict(), f'weights_normmat_whole_4fold/torch_ensemble_10k_48.pt')