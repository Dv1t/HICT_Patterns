...
torch.save(model.state_dict(), f'weights_2heads_normmat_logchange_raw/torch_ensemble_25k_48_diag.pt')
...
torch.save(model.state_dict(), f'weights_2heads_normmat_logchange_raw/torch_ensemble_50k_48_diag.pt')
...
torch.save(model.state_dict(), f'weights_2heads_normmat_logchange_raw/torch_ensemble_10k_48_diag.pt')