...
os.makedirs(f'weights_{cfg.model_name[1]}', exist_ok=True)
...
train_dataset = TrainDatasetDiagonal(
    ...
    resolution=25000,
    image_size=48,
    normmat_path=cfg.normmats_path_train[1],
    normmat_clean_path=cfg.normmats_clean_path_train[1])
...
validate_dataset = TrainDatasetDiagonal(
    ...
    resolution=25000,
    image_size=48,
    normmat_path=cfg.normmats_path_val[1],
    normmat_clean_path=cfg.normmats_clean_path_val[1],
    validate=True)
...
train_model(dataloaders, model, f'log_25kb_{cfg.model_name[1]}', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name=cfg.model_name[1])
torch.save(model.state_dict(), f'weights_{cfg.model_name[1]}/normmat_cg_48_diag_25Kbp.pt')
print(f'Trained 25kb {cfg.model_name[1]} with config {args.cfg_path}')