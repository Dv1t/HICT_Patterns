...
from hict.patterns.models import ClassificationModel
...
torch.save(model.state_dict(), f'weights_single_conv/torch_ensemble_25k_48_diag.pt')
...
torch.save(model.state_dict(), f'weights_single_conv/torch_ensemble_50k_48_diag.pt')
...
torch.save(model.state_dict(), f'weights_single_conv/torch_ensemble_10k_48_diag.pt')
