...
os.makedirs('weights_balance_single_50kb', exist_ok=True)
...
train_model(dataloaders, model, 'log_balance_single_50kb', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name='balance_single_50kb')
torch.save(model.state_dict(), f'weights_balance_single_50kb/balance_single_50kb.pt')

print('Trained balance_single_50kb')