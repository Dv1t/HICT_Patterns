...
class TrainDatasetDiagonal(Dataset):
    def __init__(self, cooler_path_list, trans_csv_path_list, resolution, image_size, clean_cooler_list):
        sv_count = 0
...
os.makedirs('weights_balance_two_matrices', exist_ok=True)
...
train_model(dataloaders, model, 'log_balance_two_matrices', criterion, optimizer, device, num_epochs, phases= ['train', 'test'], model_name='balance_two_matrices')
torch.save(model.state_dict(), f'weights_balance_two_matrices/torch_ensemble_balance_48_diag.pt')
