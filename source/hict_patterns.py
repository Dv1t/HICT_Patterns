...
def predict(file_path, search_in_1k, batch_size, device):
    ...
    resolution_1 = 50000
    image_size_1 = 48
    dataset = EvalDatasetDiag(file_path, resolution=resolution_1, image_size=image_size_1, step=image_size_1//2)
    ...
    image_size_3 = 48
    resolution_3 = 10000
    dataset = PatchesDataset(file_path, resolution_3, image_size_3, coords_set)
    ...
    image_size_4 = 48
    resolution_4 = 5000
    dataset = ClarifyDataset(file_path, resolution_4, image_size_4, detected_3, image_size_3, resolution_3)
    ...
    if search_in_1k:
        ...
        dataset = ClearPatchesDataset(file_path, resolution_6, image_size_6, detected_5)
    ...
    for d in last_detections:
        results.append((d[0]*last_resolution, d[1]*last_resolution))
